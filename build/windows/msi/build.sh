...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="ScribeEditor - Insiders"
  PRODUCT_CODE="ScribeEditorInsiders"
  ...
  PRODUCT_NAME="ScribeEditor"
  PRODUCT_CODE="ScribeEditor"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="ScribeEditor-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="ScribeEditor-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
